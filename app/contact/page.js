            ...
            <div className="flex justify-center">
              <div className="bg-transparent bg-gradient-to-tr from-orange-400 via-red-700 to-yellow-300 w-[400px] h-[425px] md:w-[500px] md:h-[510px] rounded-lg mt-1.5">
                ...
                <div className="flex-col flex">
                  <div className="ml-17 md:ml-25 ">
                    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=timothyabidemi4618@gmail.com" target="_blank"  rel="noopener noreferrer">
                      <button className="relative rounded-full shadow-2xl w-68 md:w-76 md:font-extrabold my-2 p-4 md:p-5 text-black font-bold bg-gradient-to-l from-red-700 via-yellow-400 to-orange-400 hover:text-white hover:scale-105 cursor-pointer">Email</button>
                      <Image src={Googlemail} alt="Googlemail"  className="w-12 md:w-14 absolute left-19 md:left-27 bottom-19 md:bottom-21.5 bg-white rounded-full drop-shadow-2xl"/>
                    </a>
                    <a href="https://wa.me/2347032603814"  target="_blank"  rel="noopener noreferrer" >
                      <button className="relative rounded-full shadow-2xl w-68 md:w-76 md:font-extrabold mb-2 p-4 md:p-5 text-black font-bold bg-gradient-to-l from-red-700 via-yellow-400 to-orange-400 hover:text-white hover:scale-105 cursor-pointer">WhatsApp</button>
                      <Image src={Whatsapp} alt="WhatsApp" className="w-12 md:w-14 absolute left-19 md:left-27 bottom-3 md:bottom-3.5 bg-white rounded-full drop-shadow-2xl"/>
                    </a>
                  </div>
                </div>
              </div>
