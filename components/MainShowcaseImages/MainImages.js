...
export default function MainImages(){
  ...
  return<div className='relative w-[400px] md:w-full ml-10 md:ml-10 md:mr-0 mt-38 md:mt-40 lg:mt-60 mb-10 h-64 md:h-96  overflow-hidden rounded-lg shadow-lg' data-aos='fade-right'
                                                                     data-aos-offset='200'
                                                                     data-aos-delay='50'
