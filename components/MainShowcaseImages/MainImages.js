...
export default function MainImages(){
  ...
  return<div className='relative min-w-[350px]  md:w-full mx-auto md:ml-5 lg:m-10 mt-38 md:mt-40 lg:mt-60 xl:mt-80 mb-10 h-64 md:h-96 overflow-hidden rounded-lg shadow-lg' data-aos='fade-right'
                                                                     data-aos-offset='200'
                                                                     data-aos-delay='50'
