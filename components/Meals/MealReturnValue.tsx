...
export default function MealReturnValue({meal, imageUrl, mealInstructions, currentUserId }: MealReturnValueProps){
  ...
  return<>
    ...
    {isedited && meal ? <EditMeal meal={meal} setIsedited={setIsedited}/> : <>
    ...
    {isdeleted && <DeleteMeal setIsdeleted={setIsdeleted} id={meal?.id ?? 0}/>}
</> 
}