...
import { useRef, useState, useEffect, type Dispatch, type SetStateAction, type ChangeEvent} from "react"
import Image from "next/image"

type PickImageProps = {
  label: string;
  name: string;
  isRequired: null | string;
  pickedImage: null | string ;
  setPickedImage: Dispatch<SetStateAction< null | string>>
}

export default function ImagePicker({label, name, isRequired, pickedImage, setPickedImage,}: PickImageProps){
  ...
  function handlePickedImage(event:ChangeEvent<HTMLInputElement>){
